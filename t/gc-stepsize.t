...
assert(collectgarbage("setpause", 200) == 170)
assert(collectgarbage("setpause", 170) == 200)
assert(collectgarbage("setstepmul", 200) == 250)
assert(collectgarbage("setstepmul", 250) == 200)
